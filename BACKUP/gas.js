...
function handleGetPrices() {
  ...
  if (testsSheet) {
    ...
    for (let i = 1; i < rows.length; i++) {
      ...
      prices[testName.toUpperCase()] = { r, s, bsa, om, yakap };  // ← bsa/om/yakap added
    ...
    // Fallback: read from legacy PRICELIST tab (no BSA/OM/YAKAP columns there)
